...
#Get common denominator of all monkeys
for monkey in range(len(monkeyTests)):
    commonDenom = commonDenom * monkeyTests[monkey][0]
...
for round in range(10000):
    ...
    for monkey in range(len(monkeyOps)):
        ...
        for item in range(len(monkeyItems[monkey])):
            ...
            #Manage worry level using least common multiple
            worryLevel = worryLevel % commonDenom
